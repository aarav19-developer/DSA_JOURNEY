...
# In class DLL, define a method insert_at_last() to insert an element at the last of the list.
...
# In class DLL, define a method insert_after() to insert a new code after a given code of the list.
...
# In class DLL, def delete_last() to delete first element from the list.
...
# In class DLL, def delete_item() to delete any specific element from the list.
...
# In a class DLL, impliment iterator for DLL to access all the elements of the list in a sequence.
...
mylist.insert_at_last(13)
mylist.insert_after(mylist.search(22),1322)
for x in mylist:
    print(x,end=' ')
print()
